...
namespace Pr2\TheTanksGame;


use Pr2\TheTanksGame\Factory\TankFactory;
use Pr2\TheTanksGame\Objects\Team;
...
class Game
{
    ...
    public function setManyPlayers(int $count)
    {
        $this->count = $count;
    }

    public function setTeamA(string $nameA)
    {
        $this->nameA = $nameA;
    }

    public function setTeamB(string $nameB)
    {
        $this->nameB = $nameB;
    }
